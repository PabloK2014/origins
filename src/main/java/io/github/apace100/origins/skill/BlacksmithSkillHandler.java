...
/**
 * Обработчик навыков кузнеца
 */
public class BlacksmithSkillHandler {
    ...
    /**
     * Обрабатывает навык "Мгновенный ремонт"
     */
    ...
    /**
     * Обрабатывает навык "Раскалённый удар"
     */
    public static void handleHotStrike(ServerPlayerEntity player, int skillLevel) {
        if (skillLevel <= 0) return;
